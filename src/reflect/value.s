...
func (value* self) type_of() type { self.kindinfo }

func (value* self) can_int() bool { self.kindinfo.kind == kind_int }

func (value* self) can_bool() bool { self.kindinfo.kind == kind_bool }

func (value* self) can_string() bool { self.kindinfo.kind == kind_string }
