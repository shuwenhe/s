...
class functionsig :
    name :str 
    generics :List [str ]=datfield(default_factory=list)
    params :List [param ]=datfield(default_factory=list)
...
class variantpattern (pattern ):
    path :str 
    args :List [pattern ]=datfield(default_factory=list)
...
class callexpr (expr ):
    callee :expr 
    args :List [expr ]=datfield(default_factory=list)
...
class structliteralexpr (expr ):
    callee :expr 
    fields :List [structfieldinit ]=datfield(default_factory=list)
...
class switchexpr (expr ):
    subject :expr 
    arms :List [switcharm ]=datfield(default_factory=list)
...
class blockexpr (expr ):
    statements :List ["stmt"]=datfield(default_factory=list)
...
class structdecl :
    name :str 
    generics :List [str ]=datfield(default_factory=list)
    fields :List [field ]=datfield(default_factory=list)
    is_public :bool =False 
...
class enumdecl :
    name :str 
    generics :List [str ]=datfield(default_factory=list)
    variants :List [enumvariant ]=datfield(default_factory=list)
    is_public :bool =False 
...
class traitdecl :
    name :str 
    generics :List [str ]=datfield(default_factory=list)
    methods :List [functionsig ]=datfield(default_factory=list)
    is_public :bool =False 
...
class impldecl :
    ...
    generics :List [str ]=datfield(default_factory=list)
    methods :List [functiondecl ]=datfield(default_factory=list)


@dataclass 
class sourcefile :
    package :str 
    uses :List [usedecl ]=datfield(default_factory=list)
    items :List [object ]=datfield(default_factory=list)
