...
func (debug_loc_propagator* dlp) enter_scope(string scope_name) {
...
func (debug_loc_propagator* dlp) exit_scope() {
    if dlp.current_depth > 0 {
        dlp.current_depth -= 1
    }
}

func (debug_loc_propagator* dlp) get_current_scope() string {
    scope := ""
...
func (dlp* debug_loc_propagator) set_location(i32 instr_id, string filename, i32 line, i32 column) {
    loc := source_location{
        filename: filename,
        line: line,
        column: column,
...
func (dlp* debug_loc_propagator) set_location_with_range(i32 instr_id, string filename, i32 line, i32 col, i32 end_line, i32 end_col) {
    loc := source_location{
        filename: filename,
        line: line,
        column: col,
...
func (dlp* debug_loc_propagator) set_variable_location(i32 instr_id, string var_name, string filename, i32 line, i32 column) {
    loc := source_location{
        filename: filename,
        line: line,
        column: column,
...
func (debug_loc_propagator* dlp) propagate_locations(instr_ids i32[]) {
...
func (debug_loc_propagator* dlp) get_location(instr_id i32) source_location {
...
func (dlp* debug_loc_propagator) get_locations_by_file(string filename) debug_loc_info[] {
...
func (debug_loc_propagator* dlp) get_locations_by_scope(string scope) debug_loc_info[] {
    result := debug_loc_info[]()
...
func (debug_loc_propagator* dlp) get_location_info(instr_id i32) debug_loc_info {
...
func (debug_loc_propagator* dlp) compute_line_maps() map[string]i32[] {
...
func (debug_loc_propagator* dlp) emit_dwarf_debug_info() string {
...
func (debug_loc_propagator* dlp) to_string() string {
