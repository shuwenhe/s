...
func (compiler_pipeline* cp) add_function(string name) ssa_function* {
...
func (compiler_pipeline* cp) analyze_function(func_idx i32) {
...
func (compiler_pipeline* cp) get_dominator_tree(func_idx i32) dominator_tree* {
...
func (compiler_pipeline* cp) get_liveness_info(func_idx i32) liveness_analyzer* {
...
func (compiler_pipeline* cp) get_alias_info(func_idx i32) alias_analysis* {
...
func (compiler_pipeline* cp) get_write_barriers(func_idx i32) wb_inserter* {
...
func (compiler_pipeline* cp) get_debug_info(func_idx i32) debug_loc_propagator* {
...
func (compiler_pipeline* cp) run_optimization_pipeline() {
...
func (compiler_pipeline* cp) emit_debug_info() string {
    s := "Debug Information:\n"
    for i := i32(0); i < i32(len(cp.functions)); i += 1 {
...
func (compiler_pipeline* cp) to_string() string {
