...
func (dominator_tree* dt) compute_dominators(preds i32[][], entry i32) {
    n := i32(len(preds))
    dom := make(bool[][], n)
...
func (dominator_tree* dt) compute_dominance_frontier(succs i32[][], preds i32[][]) {
    n := i32(len(preds))
...
func (dominator_tree* dt) strictly_dominates(a i32, b i32) bool {
    if a == b {
        return false
    }
...
func (dominator_tree* dt) get_idom(block i32) i32 {
...
func (dominator_tree* dt) get_dom_children(block i32) i32[] {
...
func (dominator_tree* dt) get_dominance_frontier(block i32) i32[] {
