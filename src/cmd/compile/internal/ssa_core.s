...
struct ssa_pipeline_options {
    ...
    enable_simplify_cfg bool
    dominant_margin_override int
}

struct ssa_program {
    function_name string
    optimized_mir_text string
    pass_mir_trace string
    pass_delta_trace string
    pass_delta_summary string
    pass_delta_structural_summary string
    pass_delta_value_summary string
    pass_delta_hot_summary string
    instruction_block_count int
    instruction_value_count int
    dominator_tree_depth int
    loop_backedge_count int
    instruction_verifier_error_count int
    instruction_verifier_error_code int
    instruction_verifier_flags string
    instruction_verifier_primary string
    instruction_verifier_stage_hint string
    instruction_verifier_stage_evidence string
    instruction_verifier_pick_matches_top bool
    instruction_verifier_pick_reason string
    memory_ssa_node_count int
    points_to_set_count int
    load_store_proof_count int
    spill_reload_pair_count int
    parallel_copy_resolution_count int
    escape_stack_alloc_count int
    escape_heap_alloc_count int
    inline_budget_score int
    devirtualization_gain_score int
    instruction_block_graph string
    instruction_value_graph string
    instruction_dominator_tree string
    instruction_loop_forest string
    instruction_memory_dep_graph string
    instruction_regalloc_plan string
    block_count int
    value_count int
    cfg_edge_count int
    branch_block_count int
    optimized_value_count int
    folded_constant_count int
    dce_removed_count int
    coalesced_move_count int
    simplified_branch_count int
    gvn_rewrite_count int
    sccp_rewrite_count int
    pre_eliminated_count int
    cse_eliminated_count int
    licm_hoisted_count int
    bce_removed_count int
    phi_node_count int
    def_use_edge_count int
    alias_set_count int
    memory_version_count int
    live_in_fact_count int
    loop_header_count int
    ...
    scheduled_pass_count int
    blocked_pass_count int
    dag_level_count int
    rerun_count int
    rollback_checkpoint_count int
    invalidation_rerun_count int
    replay_step_count int
    debug_budget_score int
    scheduler_priority_score int
    scheduler_conflict_count int
    replay_stability_hash int
    alias_precision_level int
    memory_ssa_chain_count int
    global_value_number_count int
    loop_proof_chain_count int
    spill_cost_score int
    split_quality_score int
    cross_block_gain_score int
    sched_throughput_score int
    sched_latency_balance_score int
    microarch_specialization_score int
    cost_model_score int
    solver_convergence_score int
    replay_determinism_score int
    pass_dsl string
    invalidation_policy string
    pass_topology_log string
    pass_replay_log string
    rollback_node string
    spill_count int
    spill_reload_count int
    call_pressure_event_count int
    live_range_split_count int
    rematerialized_value_count int
    regalloc_reuse_count int
    regalloc_max_live int
...
struct regalloc_result {
    ...
    spill_count int
    spill_reload_count int
    call_pressure_events int
    live_range_splits int
    rematerialized_values int
    reuse_count int
    max_live int
}
...
func run_optimization_passes(string mir_text, ssa_dataflow_model model, ssa_pipeline_options options) ssa_pass_stats {
    ...
    rollback_node := "none"
    prev := -1
    for fixed_iters < max_iters && stable_iters < 2 {
        prev = current
        rollback_value = current
