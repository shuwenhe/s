...
func (elf_output* out) add_string_to_table(string s) int32 {
    result := len(out.string_table) as int32
    out.string_table = out.string_table + s + "\x00"
    result
}

func (elf_output* out) create_section(string name, int32 type, int64 flags, int64 size) {
...
func (elf_output* out) build_standard_sections() {
...
func (elf_output* out) add_symbol(string name, int64 value, int64 size, int8 info, int16 shndx) {
    sym := elf_symbol {
...
func (elf_output* out) write_elf_file() int8[] {
    result := int8[]()()
...
struct object_file_generator {
    code_gen* machine_code_gen
    symbols* symbol_table
    relocs* relocation_context
    elf_out elf_output
}

func make_object_file_generator(cg* machine_code_gen,st* symbol_table,rc* relocation_context) object_file_generator {
    obj_file_generator {
        code_gen: cg, symbols st, relocs rc, elf_out make_elf_output(),
    }
}

func (object_file_generator* gen) generate() int8[] {
...
func (object_file_generator* gen) dump_info() string {
