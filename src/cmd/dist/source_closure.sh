...
# Conservative fallback: record the entry and every directly imported module
# that maps unambiguously to a source file. The bootstrap audit must never
# silently claim a smaller closure merely because the optional resolver was
# not built.
{
    printf '%s\n' "$entry"
