...
func parse_path(args: Vec[String]) -> Result[String, CliError] {
    if len(args) < 2 {
...
func read_source(path: String) -> Result[String, CliError] {
...
func lex_source(source: String) -> Result[Vec[Token], CliError] {
