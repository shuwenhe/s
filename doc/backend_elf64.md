...
[`backend_elf64.py`](/app/s/src/cmd/compiler/backend_elf64.py), but rewritten as an
...
[`backend_elf64_runner_bootstrap.c`](/app/s/src/cmd/compiler/backend_elf64_runner_bootstrap.c),
...
- [main.s](/app/s/src/cmd/compiler/main.s) already has a `build` command path
- [backend_elf64.s](/app/s/src/cmd/compiler/backend_elf64.s) is still a stub
- the runnable implementation still lives in
  [backend_elf64.py](/app/s/src/cmd/compiler/backend_elf64.py)
