...
- `ast.py` 已有对应 S 版 [frontend/ast.s](/app/s/src/frontend/ast.s)
- `tokens.py` 已有对应 S 版 [frontend/tokens.s](/app/s/src/frontend/tokens.s)
- `lexer.py` 已有对应 S 版 [frontend/lexer.s](/app/s/src/frontend/lexer.s)
- `parser.py` 已有对应 S 版 [frontend/parser.s](/app/s/src/frontend/parser.s)
