...
- [compiler/tests/test_golden.s](/app/s/compiler/tests/test_golden.s)
- [compiler/tests/test_semantic.s](/app/s/compiler/tests/test_semantic.s)
- [compiler/tests/test_mir.s](/app/s/compiler/tests/test_mir.s)
...
把 [hosted_frontend.py](/app/s/runtime/hosted_frontend.py) 的“解释执行 parser helper”角色拆开。
...
把 [python_bridge.py](/app/s/runtime/python_bridge.py) 缩成最薄的宿主适配层。
