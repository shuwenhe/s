...
- 还没有 golden test runner 去自动比对 [sample.tokens](/app/s/compiler/tests/fixtures/sample.tokens)
...
3. 用 [sample.s](/app/s/compiler/tests/fixtures/sample.s) 跑出和 [sample.tokens](/app/s/compiler/tests/fixtures/sample.tokens) 对齐的输出
