...
- [spec.md](/app/s/docs/spec.md)
- [syntax.md](/app/s/docs/syntax.md)
- [types.md](/app/s/docs/types.md)
- [ownership.md](/app/s/docs/ownership.md)
...
- `size_of[T]() -> usize`
- `align_of[T]() -> usize`
- `replace[T](place: &mut T, value: T) -> T`
- `take[T: Default](place: &mut T) -> T`
